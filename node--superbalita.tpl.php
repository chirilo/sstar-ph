...
*/
    ...
    <?php /*<center><a style="cursor: pointer; width: 100%; font-size: 22px; font-weight: bold; background-color: #ff8519 !important;" class="button show-comments">View Comments</a></center> */ ?>
	  <!--Disqus-->
    <!-- An element a visitor can click if they <3 comments! - Chirilo September 9, 2016 -->
      <center><a style="cursor: pointer; width: 100%; font-size: 22px; font-weight: bold; background-color: #ff8519 !important;" class="button show-comments">View Comments</a></center>
