...
function newsplus_preprocess_page(&$variables) {
	...
	/**
	*	For specific page template for specific taxonomy term pages - Chi Rilo (Dec 22, 2016)
	*/
	 ...
	 */
	if (drupal_is_front_page() || isset($variables['node']) && ($variables['node']->type == 'blog' || $variables['node']->type == 'article' || $variables['node']->type == 'mt_post' || $variables['node']->type == 'profile' || $variables['node']->type == 'video' || $variables['node']->type == 'front_pages' || $variables['node']->type == 'media_image' || $variables['node']->type == 'superbalita' || $variables['node']->type == 'page')) {
     ...
     * - edit by Chi Rilo - Dec 27, 2016 (Implementation of the NEW Design for 2017 SunStar Philippines Merge)
    */
    $alias = drupal_get_path_alias($_GET['q']);
    $path_part = explode ('/', $alias, 3);
    $location = strtolower($path_part[0]);
    
    /* Commented out - Dec 27, 2016 - Chi Rilo */
    ...
    /* Temporary Implementation of new SunStar logo designs - Chi Rilo - Dec 27, 2016*/
    $ss_logo = ('sites/default/files/logos/newdesign/sunstar-' . $location  . '-logo-new.png');
    $logo_network = ('/sites/default/files/logos/newdesign/sunstar-network-logo-new-2.png');
    //$logo_network = ('/sites/default/files/logos/newdesign/sunstar-network-logo.png');
    ...
    /* Temporary Implementation of new SunStar logo designs - Chi Rilo - Dec 27, 2016*/
    $variables['logo'] = base_path() . 'sites/default/files/logos/newdesign/sunstar-' . $location . '-logo-new.png';
    ...
    /* Get the Affiliate Location- Chi Rilo Feb 25 2017 */
    $variables['location'] = $location == 'node' ? strtoupper('Philippines') : strtoupper($location);
    $variables['new_site_name'] = 'SunStar ';
