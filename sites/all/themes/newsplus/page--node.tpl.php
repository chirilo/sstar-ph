                            ...
                            <div id="logo-and-site-name-wrapper" class="clearfix">
                                <div id="site-name" style="margin: 0 auto !important; float: left !important;">
                                    <a href="#">
                                        <ul style="list-style-type: none; padding-left: 0px;">
                                            <li style="float: left;"><img id="section-btn" src="http://www.sunstar.com.ph/sites/default/files/logos/newdesign/sections-btn.png" alt="Section" /></li>
                                            <li style="float: left;"><img src="http://www.sunstar.com.ph/sites/default/files/logos/newdesign/sections-text.png" alt="Sections" /></li>
                                        </ul>
                                    </a>
                                </div>
                                <?php if ($logo):?>
                                ...
                                <div id="todays-paper" style="margin: 0 auto !important; float: right !important;">
                                    <ul style="list-style-type: none; padding-top: 5px;">
                                        <li>
                                            <img src="http://www.sunstar.com.ph/sites/default/files/logos/newdesign/todays-paper-weather-search.png" />
