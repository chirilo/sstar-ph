<?php
    ...
    else if (strpos($location, 'SEARCH') !== false || strpos($location, 'AUTHOR') !== false || strpos($location, 'USERS') !== false || strpos($location, 'VIDEOS') !== false) {
...
<!-- Custom Header -->
<!-- Start Navigation -->
<nav id="nav_desktop" class="navbar navbar-default brand-center center-side bootsnav" style="display: none;">
    <!-- Start Top Search -->
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
                ...
                <li>
                    ...
                    <div class="attr-nav">
                        <ul>
                            <li><a href="http://epaper.sunstar.com.ph/epaper/viewer.aspx" target="_blank"><img src="http://www.sunstar.com.ph/sites/all/themes/newsplus/bootsnav/images/todays-paper-180x40.png" /></a></li>
                    ...
                    <div><span style="margin-right: 30%; color: #000;"><?php echo date("D, F j, Y");?></span></div>
    ...
    <div class="container">  
        ...
        <div class="navbar-header">
            ...
            <button id="bar_mobile" type="button" class="navbar-toggle" data-toggle="" data-target="" style="background-color: transparent !important;">
                <i class="fa fa-bars" style="visibility: hidden;"></i>
            </button>
                ...
                <div class="<?php print $header_top_inside_left_grid_class; ?>">
                    ...
                    <div id="header-top-left" class="clearfix">
                        <div class="header-top-area">
                            ...
                            <div style="display: none;" id="logo-and-site-name-wrapper" class="clearfix">
                                <?php if ($logo):?>
                                <div id="logo">
                            ...
                            <?php /* new design - Chi Rilo - Dec 29, 2016 */ ?>
                            <div id="logo-and-site-name-wrapper" class="clearfix">
                                <div id="" style="display: block !important; margin: 0 auto !important; float: left !important; padding-top: 10px;">
                                    <!-- <img src="http://placehold.it/50x50?text=6"> -->
                                    <img src="sites/default/files/logos/newdesign/sections.png">
                                </div>
                                <?php if ($logo):?>
                                <center>
                                ...
                                <div id="" style="display: block !important; margin: 0 auto !important; float: right !important;">
                                    <ul style="list-style-type: none;">
                                        <li>
                                            <img src="sites/default/files/logos/newdesign/todays-paper-weather-search.png" />
                                        </li>
                                        <li style="letter-spacing: 2px; color: #000;"><?php echo date("D, F j, Y");?></li>
                                    </ul>
                                </div>
                                </center>
                                <?php endif; ?>
